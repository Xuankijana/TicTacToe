...
public class Cell {
	...
	public Cell(int row, int col) {
		...
		// NOTE: Initialise the variables row, col 
		this.row = row;
		this.col = col;
		
		//NOTE: call the method that sets the cell content to EMPTY
		clear(); 
	}
	...
	public void clear() {
		// NOTE: Set the value of content to Empty (Remember this is an enum)
